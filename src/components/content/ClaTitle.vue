<template>
  <div :class="{ classtitle: !fixed, classtitle_fix: fixed }">
    ...
    >
      <template v-slot:mes>
        <p v-if="!total">当前购物车为空</p>
        <div v-else>
          <div class="sc_content_title">天猫超市</div>
          <div class="sc_content_cont">
            <ScGood
              class="scGood"
          ...
          <div class="sc_content_totalPrice">
